...
\item[Information:] If you would like to give a presentation, please send a title, abstract, and date to \htmladdnormallink{Collin.A.Vaughan@usace.army.mil}{mailto:Collin.A.Vaughan@usace.army.mil}.
...
\item[Nov 16] Introduction to Hyperbolic Waves, the Method of Characteristics and Transport Processes\\
Matthew Farthing (CHL)\\

\item[Nov 30] Hyperbolic Wave Propogation with Discontinous Galerkin Methods\\
Chris Massey (CHL)\\

\item[Dec 14] Nonlinear Theories of Dispersive Water Waves\\
Matt Malej (CHL)\\

\item[Jan 2012] Stablized Finite Element Methods for Traveling Waves in Two-Phase Flow\\
Amanda Hines (ITL)\\

\item[Jan 2012] Diffusive Waves For Overland Flow\\
Kevin Winters (CHL)\\
