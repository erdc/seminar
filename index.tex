...
\item[Mailing List:] To subscribe, \htmladdnormallink{email}{mailto:majordomo@lst.usace.army.mil} and empty message with the subject line 'subscribe ls-cms'.
...
\item[Oct 5] Introduction and General Outline Of Analytical and
  ...
  the classic text, \htmladdnormallink{Linear and Nonlinear
